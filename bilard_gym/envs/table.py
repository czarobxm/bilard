...
class Table():
    def __init__(self):
        ...
        self.shape_floor_left = pymunk.Segment(self.body_floor_left,
        ...
        self.shape_floor_right = pymunk.Segment(self.body_floor_right,
        ...
        self.shape_right_wall = pymunk.Segment(self.body_right_wall, TABLE_SIDE_RIGHT_WALL[0], TABLE_SIDE_RIGHT_WALL[1],
                                               1)

        self.body_ceiling_left = pymunk.Body(body_type=pymunk.Body.STATIC)
        self.shape_ceiling_left = pymunk.Segment(self.body_ceiling_left, TABLE_UPPER_LEFT_WALL[0],
                                                 TABLE_UPPER_LEFT_WALL[1], 1)

        self.body_ceiling_right = pymunk.Body(body_type=pymunk.Body.STATIC)
        self.shape_ceiling_right = pymunk.Segment(self.body_ceiling_right, TABLE_UPPER_RIGHT_WALL[0],
                                                  TABLE_UPPER_RIGHT_WALL[1], 1)
