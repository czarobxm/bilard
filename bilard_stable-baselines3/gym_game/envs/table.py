...
class Table():
    def __init__(self):
        ...
        # COLLISION TYPE
        # walls
        self.shape_floor_left.collision_type = 3
        self.shape_floor_right.collision_type = 3
        self.shape_left_wall.collision_type = 3
        self.shape_right_wall.collision_type = 3
        self.shape_ceiling_left.collision_type = 3
        self.shape_ceiling_right.collision_type = 3
        # bottom holes
        self.shape_hole_bottom_left_one.collision_type = 3
        self.shape_hole_bottom_left_two.collision_type = 3
        self.shape_hole_bottom_center_one.collision_type = 3
        self.shape_hole_bottom_center_two.collision_type = 3
        self.shape_hole_bottom_right_one.collision_type = 3
        self.shape_hole_bottom_right_two.collision_type = 3
        # upper holes
        self.shape_hole_upper_left_one.collision_type = 3
        self.shape_hole_upper_left_two.collision_type = 3
        self.shape_hole_upper_center_one.collision_type = 3
        self.shape_hole_upper_center_two.collision_type = 3
        self.shape_hole_upper_right_one.collision_type = 3
        self.shape_hole_upper_right_two.collision_type = 3
